  ...
  function reachPlanetHandler(ufoBundle, sun, earthCoords, marsCoords, venusCoords) {
    ...
    if (ufoBundle.right > venusCoords.left && ufoBundle.left < venusCoords.right && ufoBundle.top < venusCoords.bottom && ufoBundle.bottom > venusCoords.top){
      ...
      if (items.box == true && items.boxKey == true && items.princess == false) {
        showMessage('img/princess2.gif', 'Hre you are your majesty. Time to escape and find a new world. This Star will now swallow the neighboring planets and turn into a black hole.');
        items.princess=true;
        createNewWorld();    
      }
    }
...
function startTheStory() {
  ...
  buttonNextStep.addEventListener('click', function() {
    if (clickCounter==1) {
      ...
      clickCounter = 1;
      speechText.textContent = 'This star will turns into a black hole, it will complete his plan. He will die with it. Do not let him destroy everything. Find a weapon that can destroy the energy dome and save my daughter. As long as she lives, a piece of our world will continue to exist in the place where you will find a new life. She is the princess of this galaxy. All that you love will die. But if you stay alive, the memory of humanity will not disappear.';  
    }
  });
};
